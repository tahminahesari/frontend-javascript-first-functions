...
// vragen hoe ik Kees kan loggen (kan ik 2 keer variabelen declareren  )
// const greet = greeter("Kees!")
// console.log(greet);
...
const sortOfMerge = merge ("zoet", "sappig");
console.log(sortOfMerge);
...
function calculateDogYears(dogAge){
  return humanAge = dogAge * 7;
}

const myDog = calculateDogYears(2);
console.log("Jouw hond is " +  myDog + " jaar oud in mensenjaren");
